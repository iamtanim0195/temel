        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { label: "Starkwindschirme / Windfeste Sonnenschirme", href: "/weitere/starkwindschirme" },
...
const Nav = () => {
    ...
    return (
        <header className="bg-black/50 text-white z-50 sticky top-0">
            ...
            {menuOpen && (
                <nav className="md:hidden border-t border-white/20 px-3 pb-3">
                    <div className="bg-black/70 text-white rounded-xl w-full mt-2 p-2 text-2xl max-h-[calc(100vh-200px)] overflow-y-auto">
...
const DesktopMegaItem = ({ item }) => (
    <div className="relative group">
        ...
        <div
            className="absolute left-1/2 transform -translate-x-1/2 top-full mt-3 bg-white text-slate-800 rounded-xl shadow-2xl opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200 ease-out w-[900px] max-w-[95vw] z-50"
        >
